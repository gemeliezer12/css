...
if(isset($_POST["submit"])){
    ...
    elseif($password !== $passwordRepeat){
        ...
        $query = $pdo->prepare("SELECT usernameUsers FROM users WHERE usernameusers=?;");
        ...
        if($query->rowCount() > 0){
            ...
            $query = $pdo->prepare("INSERT INTO users(usernameUsers, emailUsers, passwordUsers) VALUES(?, ?, ?);");
